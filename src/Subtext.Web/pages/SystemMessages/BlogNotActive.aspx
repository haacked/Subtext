<%@ Page Language="C#" EnableTheming="false"  Title="Subtext - This Blog Is Inactive" MasterPageFile="~/pages/SystemMessages/SystemMessageTemplate.Master" Codebehind="BlogNotActive.aspx.cs" AutoEventWireup="True" Inherits="Subtext.Web.BlogNotActive" %>
