<%@ Page Language="C#" EnableTheming="false"  Title="Subtext - Your Blog Cannot Connect To The Database" MasterPageFile="~/pages/SystemMessages/SystemMessageTemplate.Master" Codebehind="CheckYourConnectionString.aspx.cs" AutoEventWireup="True" Inherits="Subtext.Web.CheckYourConnectionString" %>
