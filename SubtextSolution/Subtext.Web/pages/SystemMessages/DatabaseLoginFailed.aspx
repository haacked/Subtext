<%@ Page Language="C#" EnableTheming="false"  Title="Subtext - Database Login Failure" MasterPageFile="~/pages/SystemMessages/SystemMessageTemplate.Master" Codebehind="DatabaseLoginFailed.aspx.cs" AutoEventWireup="True" Inherits="Subtext.Web.DatabaseLoginFailed" %>
