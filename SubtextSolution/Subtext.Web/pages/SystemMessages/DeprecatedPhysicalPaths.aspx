<%@ Page Language="C#" Title="Subtext - Upgrade Is Not Complete" CodeBehind="DeprecatedPhysicalPaths.aspx.cs" Inherits="Subtext.Web.pages.SystemMessages.DeprecatedPhysicalPaths" MasterPageFile="~/pages/SystemMessages/SystemMessageTemplate.Master"  %>
...
<asp:Content id="mainContent" ContentPlaceHolderID="Content" runat="server">
    ...
    <p>
        The latest version of Subtext moved these files/folders into the "pages" directory.
    </p>
