...
<MP:MasterPage id="MPContainer" TemplateFile="~/Install/PageTemplate.ascx" runat="server">
	<MP:ContentRegion id="MPTitle" runat="server">Subtext - Your Blog Has Not Been Configured 
Yet</MP:ContentRegion>
	<MP:ContentRegion id="MPSubTitle" runat="server">But I Can 
Help You</MP:ContentRegion>
