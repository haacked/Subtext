<%@ Page language="c#" Title="Subtext Admin - Confirmation Dialog" MasterPageFile="~/Admin/WebUI/AdminPageTemplate.Master"  Codebehind="Confirm.aspx.cs" AutoEventWireup="false" Inherits="Subtext.Web.Admin.Pages.Confirm" %>
...
<asp:Content ID="confirmContent" ContentPlaceHolderID="pageContent" runat="server">
	...
	<st:AdvancedPanel id="Header" runat="server" DisplayHeader="true" CssClass="Dialog" HeaderCssClass="DialogTitle" BodyCssClass="DialogBody" HeaderText="Confirm Action" LinkText="[toggle list]"> 
