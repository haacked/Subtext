...
<asp:Content ID="configurationOptions" ContentPlaceHolderID="pageContent" runat="server">
	...
	<st:AdvancedPanel id="Edit" runat="server" Collapsible="False" HeaderText="Configure" HeaderCssClass="CollapsibleHeader" BodyCssClass="Edit" DisplayHeader="true">
		<asp:Panel runat="server" GroupingText="Main Settings" CssClass="options" >
				...
				<asp:TextBox id="txbAuthor" runat="server" CssClass="textbox"></asp:TextBox>
			
				<label accesskey="e" for="Edit_txbAuthorEmail">Owner's <u>E</u>mail</label>
				<asp:TextBox id="txbAuthorEmail" runat="server" CssClass="textbox"></asp:TextBox>
		...
		<!--Mail to Weblog UI-->
			...
			<div>
				<asp:CheckBox id="ckbPop3MailToWeblog" runat="server" CssClass="checkbox" AccessKey="m" Text="Enable <u>M</u>ailToWeblog" />
			</div>
