...
<asp:Content ID="configurationOptions" ContentPlaceHolderID="pageContent" runat="server">
	...
	<div class="Edit" id="configure-form">
		<asp:Panel runat="server" GroupingText="Main Settings" CssClass="options" >
			...
			<label accesskey="s" for="Edit_mobileSkinDropDown">Mobile <u>S</u>kin</label>
			...
			<asp:UpdatePanel ID="ajaxTimezone" runat="server">
			    <ContentTemplate>
			        <p>
				        ...
				        <asp:DropDownList id="ddlTimezone" runat="server" OnSelectedIndexChanged="ddlTimezone_SelectedIndexChanged" AutoPostBack="true" CssClass="wide-dropdown">
