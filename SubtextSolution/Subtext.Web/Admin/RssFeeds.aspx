<%@ Page Language="C#" EnableTheming="false"  Title="Subtext Admin - Rss Feed Generator"  MasterPageFile="~/Admin/WebUI/AdminPageTemplate.Master" Codebehind="RssFeeds.aspx.cs" AutoEventWireup="True" Inherits="Subtext.Web.Admin.Pages.RssFeeds" %>
...
<script type="text/javascript">
	function UpdateForm()
	{
		var page = '<%=Subtext.Framework.Configuration.Config.CurrentBlog.UrlFormats.AdminUrl("AdminRss.aspx") %>';
