<%@ Page Language="C#" EnableTheming="false" CodeBehind="default.aspx.cs" MasterPageFile="~/Admin/WebUI/AdminPageTemplate.Master" AutoEventWireup="true" Inherits="Subtext.Web.Admin.Pages.HomePageDefault" %>
<%@ Register TagPrefix="st" TagName="RecentComments" Src="UserControls/RecentComments.ascx" %>
<%@ Register TagPrefix="st" TagName="RecentPosts" Src="UserControls/RecentPosts.ascx" %>
<%@ Register TagPrefix="st" TagName="PopularPosts" Src="UserControls/PopularPosts.ascx" %>

<asp:Content ContentPlaceHolderID="head" runat="server">
    <link id="Link1" type="text/css" rel="stylesheet" href="<%= VirtualPathUtility.ToAbsolute("~/Admin/Resources/dashboard.css") %>" />
</asp:Content>
