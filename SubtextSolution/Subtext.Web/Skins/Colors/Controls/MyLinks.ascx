...
<ul id="nav">
	...
	<li><asp:HyperLink Runat="server"  CssClass="listitem" NavigateUrl="~/Rss.aspx" Text="Syndication" ID="Syndication" /> <asp:HyperLink Runat="server" NavigateUrl="~/Rss.aspx" ID="XMLLink" />
