        ...
        <fieldset id="respond">
            ...
            <div>
                ...
                <div id="guest_url" class="clearfix" style="display: none;">
                    <label for="PostComment.ascx_tbUrl">Your blog:</label>
                ...
                <div id="guest_email" class="clearfix" style="display: none;">
                    <label for="PostComment.ascx_tbEmail">Your email:</label>
            ...
            <div class="required clearfix">
                <label for="PostComment.ascx_tbComment"><em>*</em>Your message:</label>
