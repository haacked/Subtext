...
<ul class="list">
	...
	<li class = "listitem"><asp:HyperLink AccessKey = "9" Runat="server" CssClass="listitem" NavigateUrl="~/ArchivePostPage.aspx" Text="Archives" ID="ArchivePostPageLink" /></li>
	<li class = "listitem"><asp:HyperLink AccessKey = "9" Runat="server" CssClass="listitem" NavigateUrl="~/LinkPage.aspx" Text="Links" ID="LinkPageLink" /></li>
