...
{
	/// <summary>
	/// Configuration section handler for the <see cref="RichTextEditorProvider"/>.  
	...
	/// </summary>
	public class RichTextEditorProviderSectionHandler: ProviderSectionHandler
	{
		/// <summary>
		/// Creates an <see cref="RichTextEditorProviderConfiguration"/> instance which 
		/// is populated by this section handler.
		/// </summary>
		public override ProviderConfiguration CreateProviderConfigurationInstance()
		{
			return new RichTextEditorProviderConfiguration();
		}
	}
}
