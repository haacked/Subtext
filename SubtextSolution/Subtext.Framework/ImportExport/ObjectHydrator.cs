...
namespace Subtext.ImportExport
{
    ...
    public static class ObjectHydrator
    {
        ...
        {
            FeedbackItem feedbackItem = reader.LoadFeedbackItem();
        ...
        {
            FeedbackItem trackback = reader.LoadFeedbackItem();
            var blogMLTrackback = new BlogMLTrackback();
        ...
        public static BlogMLCategory CreateCategoryInstance(string id, string title, string description, bool approved,
                                                            string parentId, DateTime dateCreated, DateTime dateModified)
        {
        ...
        public static BlogMLPost CreatePostInstance(string id, string title, string url, bool approved, string content,
        ...
        public static BlogMLComment CreateCommentInstance(string id, string title, string url, string content,
                                                          string email, string userName, bool approved,
                                                          DateTime dateCreated, DateTime dateModified)
        {
            var comment = new BlogMLComment();
            comment.ID = id;
        ...
        public static BlogMLTrackback CreateTrackBackInstance(string id, string title, string url, bool approved,
                                                              DateTime dateCreated, DateTime dateModified)
        {
