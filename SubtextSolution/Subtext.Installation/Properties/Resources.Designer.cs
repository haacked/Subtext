...
namespace Subtext.Installation.Properties {
    using System;
    ...
    internal class Resources {
        ...
        internal static global::System.Resources.ResourceManager ResourceManager {
            get {
                if (object.ReferenceEquals(resourceMan, null)) {
                    global::System.Resources.ResourceManager temp = new global::System.Resources.ResourceManager("Subtext.Installation.Properties.Resources", typeof(Resources).Assembly);
                    resourceMan = temp;
                }
                return resourceMan;
            }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cannot determine whether a null exception is an installation exception.  This exception should never be thrown..
        /// </summary>
        internal static string ArgumentNull_ExceptionCritical {
            get {
                return ResourceManager.GetString("ArgumentNull_ExceptionCritical", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to A SQL Server Connection String that can connect to and read from your .TEXT database..
        /// </summary>
        internal static string Import_dotTextConnectionStringDescription {
            get {
                return ResourceManager.GetString("Import_dotTextConnectionStringDescription", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to .TEXT Connection String.
        /// </summary>
        internal static string Import_dotTextConnectionStringTitle {
            get {
                return ResourceManager.GetString("Import_dotTextConnectionStringTitle", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to I&amp;#8217;m sorry, but it does not appear that there is a .TEXT database corresponding to the connection string provided. Please double check that the &amp;#8220;blog_config&amp;#8221; table exists. If it does, double check that it was created using the [dbo] account OR by the same user specified in the .TEXT connection string below..
        /// </summary>
        internal static string ImportError_dotTextDatabaseNotFound {
            get {
                return ResourceManager.GetString("ImportError_dotTextDatabaseNotFound", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Please specify a valid connection string to the .TEXT 0.95 database..
        /// </summary>
        internal static string ImportError_InvalidConnectionString {
            get {
                return ResourceManager.GetString("ImportError_InvalidConnectionString", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The format for the connection string is incorrect. Please double check it and try again..
        /// </summary>
        internal static string ImportError_InvalidConnectionStringFormat {
            get {
                return ResourceManager.GetString("ImportError_InvalidConnectionStringFormat", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to There was an error while trying to connect to the database.  The error is &amp;#8220; {0} &amp;#8221;.
        /// </summary>
        internal static string ImportError_SqlException {
            get {
                return ResourceManager.GetString("ImportError_SqlException", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to I&amp;#8217;m sorry, but it does not appear that there is a Subtext database corresponding to the connection string within web.config. Please double check that the &amp;#8220;subtext_config&amp;#8221; table exists. If it does, double check that it was created using the [dbo] account OR by the same user specified in the subText connection string..
        /// </summary>
        internal static string ImportError_SubtextDatabaseNotFound {
            get {
                return ResourceManager.GetString("ImportError_SubtextDatabaseNotFound", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to A SQL Connection String with the rights to create SQL Database objects such as Stored Procedures, Table, and Views..
        /// </summary>
        internal static string InstallationProvider_ConnectionStringDescription {
            get {
                return ResourceManager.GetString("InstallationProvider_ConnectionStringDescription", resourceCulture);
            }
        }
        ...
        /// </summary>
        internal static string InstallationProvider_ConnectionStringTitle {
            get {
                return ResourceManager.GetString("InstallationProvider_ConnectionStringTitle", resourceCulture);
            }
        }
    }
}
