...
{
    [TestFixture]
    public class SubtextBlogMLConverterTests
    {
        [Test]
        public void ConvertBlog_WithSubtextBlog_ReturnsCorrespondingBlogMLBlog()
        {
            ...
            var converter = new SubtextBlogMLConverter(subtextContext.Object);
        ...
        public void ConvertComment_WithFeedBackItem_ConvertsToBlogMlComment()
        {
            ...
            Assert.AreEqual(dateModified, comment.DateModified);
        }
