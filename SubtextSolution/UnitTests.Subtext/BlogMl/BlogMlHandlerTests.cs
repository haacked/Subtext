...
namespace UnitTests.Subtext.BlogML
{
    ...
    public class BlogMlHandlerTests
    {
        ...
        public void ProcessRequest_RendersBlogMl()
        {
            ...
            subtextContext.Setup(c => c.Repository.GetCategories(CategoryType.PostCollection, false)).Returns(
                new Collection<LinkCategory>());
            ...
            //act
            HttpContext.Current = new HttpContext(new HttpRequest("t", "http://example.com", ""),
            ...
            Assert.AreEqual("MasterChief",
                            xml.SelectSingleNode("/bml:blog/bml:authors/bml:author/bml:title", nsmgr).InnerText);
        }
    }
}