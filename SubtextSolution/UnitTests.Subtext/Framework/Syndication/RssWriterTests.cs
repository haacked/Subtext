...
namespace UnitTests.Subtext.Framework.Syndication
{
	...
	public class RssWriterTests : SyndicationTestBase
	{
		...
		public void RssImageUrlConcatenatedProperly(string application, string subfolder, string expected)
		{
			...
			using (BlogRequestSimulator.SimulateRequest(blogInfo, "localhost", application, subfolder))
			{
		...
		public void RssWriterProducesValidFeed()
		{
			...
			using (BlogRequestSimulator.SimulateRequest(blogInfo, "localhost", "Subtext.Web", string.Empty))
			{
				...
				string expected = @"<rss version=""2.0"" "
				                  ...
				                  + indent(3) + @"<link>http://localhost/Subtext.Web/archive/1975/01/23/1001.aspx</link>" +
				                  Environment.NewLine
				                  + indent(3) +
				                  ...
				                  + indent(3) + @"<guid>http://localhost/Subtext.Web/archive/1975/01/23/1001.aspx</guid>" +
				                  Environment.NewLine
				                  ...
				                  + indent(3) + @"<link>http://localhost/Subtext.Web/archive/1976/05/25/1002.aspx</link>" +
				                  Environment.NewLine
				                  + indent(3) +
				                  @"<description>Body of 1002&lt;img src=""http://localhost/Subtext.Web/aggbug/1002.aspx"" width=""1"" height=""1"" /&gt;</description>" +
				                  Environment.NewLine
				                  + indent(3) + @"<dc:creator>Phil Haack</dc:creator>" + Environment.NewLine
				                  + indent(3) + @"<guid>http://localhost/Subtext.Web/archive/1976/05/25/1002.aspx</guid>" +
				                  Environment.NewLine
				                  ...
				                  + indent(3) + @"<link>http://localhost/Subtext.Web/archive/1979/09/16/1003.aspx</link>" +
				                  Environment.NewLine
				                  + indent(3) +
				                  @"<description>Body of 1003&lt;img src=""http://localhost/Subtext.Web/aggbug/1003.aspx"" width=""1"" height=""1"" /&gt;</description>" +
				                  Environment.NewLine
				                  + indent(3) + @"<dc:creator>Phil Haack</dc:creator>" + Environment.NewLine
				                  + indent(3) + @"<guid>http://localhost/Subtext.Web/archive/1979/09/16/1003.aspx</guid>" +
				                  Environment.NewLine
				                  ...
				                  + indent(3) + @"<link>http://localhost/Subtext.Web/archive/2003/06/14/1004.aspx</link>" +
				                  Environment.NewLine
				                  + indent(3) +
				                  @"<description>Body of 1004&lt;img src=""http://localhost/Subtext.Web/aggbug/1004.aspx"" width=""1"" height=""1"" /&gt;</description>" +
				                  Environment.NewLine
				                  + indent(3) + @"<dc:creator>Phil Haack</dc:creator>" + Environment.NewLine
				                  + indent(3) + @"<guid>http://localhost/Subtext.Web/archive/2003/06/14/1004.aspx</guid>" +
				                  Environment.NewLine
		...
		public void RssWriterHandlesRFC3229DeltaEncoding()
		{
			...
			using (BlogRequestSimulator.SimulateRequest(blogInfo, "localhost", "Subtext.Web", string.Empty))
			{
				...
				RssWriter writer =
					new RssWriter(entries, DateTime.ParseExact("05/25/1976", "MM/dd/yyyy", CultureInfo.InvariantCulture), true);
				...
				string expected =
					...
					+ indent(3) + @"<pubDate>Sat, 14 Jun 2003 07:00:00 GMT</pubDate>" + Environment.NewLine
					+ indent(3) + @"<comments>http://localhost/Subtext.Web/archive/2003/06/14/1004.aspx#feedback</comments>" +
					Environment.NewLine
					+ indent(3) + @"<wfw:commentRss>http://localhost/Subtext.Web/comments/commentRss/1004.aspx</wfw:commentRss>" +
					Environment.NewLine
					+ indent(2) + @"</item>" + Environment.NewLine
					+ indent(2) + @"<item>" + Environment.NewLine
					+ indent(3) + "<title>Title of 1003.</title>" + Environment.NewLine
					...
					+ indent(3) + @"<pubDate>Sun, 16 Sep 1979 07:00:00 GMT</pubDate>" + Environment.NewLine
					+ indent(3) + @"<comments>http://localhost/Subtext.Web/archive/1979/09/16/1003.aspx#feedback</comments>" +
					Environment.NewLine
					+ indent(3) + @"<wfw:commentRss>http://localhost/Subtext.Web/comments/commentRss/1003.aspx</wfw:commentRss>" +
					Environment.NewLine
					+ indent(2) + "</item>" + Environment.NewLine
					+ indent() + "</channel>" + Environment.NewLine
					+ "</rss>";
				...
				Assert.AreEqual(DateTime.ParseExact("05/25/1976", "MM/dd/yyyy", CultureInfo.InvariantCulture),
				                writer.DateLastViewedFeedItemPublished,
				                "The Item ID Last Viewed (according to If-None-Since is wrong.");
				Assert.AreEqual(DateTime.ParseExact("06/14/2003", "MM/dd/yyyy", CultureInfo.InvariantCulture),
		...
		public void RssWriterSendsWholeFeedWhenRFC3229Disabled()
		{
			...
			using (BlogRequestSimulator.SimulateRequest(blogInfo, "localhost", "Subtext.Web", string.Empty))
			{
				List<Entry> entries = new List<Entry>(CreateSomeEntriesDescending());
				RssWriter writer =
					new RssWriter(entries, DateTime.ParseExact("06/14/2003", "MM/dd/yyyy", CultureInfo.InvariantCulture), false);
				...
				string expected =
					...
					+ indent(3) + "<pubDate>Tue, 25 May 1976 07:00:00 GMT</pubDate>" + Environment.NewLine
					+ indent(3) + "<comments>http://localhost/Subtext.Web/archive/1976/05/25/1002.aspx#feedback</comments>" +
					Environment.NewLine
					+ indent(3) + "<wfw:commentRss>http://localhost/Subtext.Web/comments/commentRss/1002.aspx</wfw:commentRss>" +
					Environment.NewLine
					+ indent(2) + "</item>" + Environment.NewLine
					+ indent(2) + @"<item>" + Environment.NewLine
					+ indent(3) + "<title>Title of 1001.</title>" + Environment.NewLine
					...
					+ indent(3) + "<pubDate>Thu, 23 Jan 1975 08:00:00 GMT</pubDate>" + Environment.NewLine
					+ indent(3) + "<comments>http://localhost/Subtext.Web/archive/1975/01/23/1001.aspx#feedback</comments>" +
					Environment.NewLine
					+ indent(3) + "<wfw:commentRss>http://localhost/Subtext.Web/comments/commentRss/1001.aspx</wfw:commentRss>" +
					Environment.NewLine
					+ indent(2) + "</item>" + Environment.NewLine
					+ indent() + "</channel>" + Environment.NewLine
					+ "</rss>";
