...
<MP:MasterPage id="MPContainer" TemplateFile="~/Install/PageTemplate.ascx" runat="server">
	<MP:ContentRegion id="MPTitle" runat="server">Subtext Installation: Step 3 - Create Blog</MP:ContentRegion>
	<MP:ContentRegion id="MPSubTitle" runat="server">Step 3 - Create Blog</MP:ContentRegion>
	<ol>
