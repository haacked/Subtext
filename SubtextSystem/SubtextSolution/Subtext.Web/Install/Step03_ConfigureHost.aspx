<%@ Page language="c#" Codebehind="Step03_ConfigureHost.aspx.cs" AutoEventWireup="false" Inherits="Subtext.Web.Install.Step03_ConfigureHost" %>
<%@ Register TagPrefix="MP" Namespace="Subtext.Web.Controls" Assembly="Subtext.Web.Controls" %>
<MP:MasterPage id="MPContainer" TemplateFile="~/Install/PageTemplate.ascx" runat="server">
	<MP:ContentRegion id="MPTitle" runat="server">Subtext Installation: Step 3 - Host 
