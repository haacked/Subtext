...
Blog</MP:ContentRegion>
	...
	<P>
		<TABLE border="0">
			<TR>
				<TD>There are currently no blogs within your system.&nbsp; In the future&nbsp;you 
					can manage blogs via the Host Admin tool. However, if you plan on only having 
					one blog, then click on the quick create button.
				</TD>
			</TR>
			<TR>
