...
<ANW:AdvancedPanel id="Edit" runat="server" LinkImageCollapsed="~/admin/resources/toggle_gray_down.gif" LinkImage="~/admin/resources/toggle_gray_up.gif" LinkStyle="Image" DisplayHeader="True" HeaderCssClass="CollapsibleTitle" Collapsible="False" HeaderText="Edit Post">
	...
	<div class="Edit">
		...
		<p class="Label">Post Body&nbsp;<asp:RequiredFieldValidator id="valtbBodyRequired" runat="server" ControlToValidate="txbBody" ForeColor="#990066" ErrorMessage="Your post must have a body"></asp:RequiredFieldValidator>
		...
		<p>
			...
			<asp:TextBox id="txbBody" runat="server" width="98%" visible="False" rows="20" textmode="MultiLine" />
		</p>
