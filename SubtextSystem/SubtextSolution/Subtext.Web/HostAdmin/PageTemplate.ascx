...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<body>
		...
		<div id="main">
			<div id="logo">
				<div id="loginStatus">Logged in As <span id="hostAdminName"><asp:Literal ID="hostAdminName" Runat="server" /></span> <span id="logoutLink">(<a href="~/Logout.aspx" id="logoutLink" runat="server">Logout</a></span>)</div>
				<h1><MP:ContentRegion id="MPSectionTitle" runat="server" /></h1>
			</div>
